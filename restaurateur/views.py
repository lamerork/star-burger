...
def view_orders(request):
    ...
    for order_item in order_items:
        ...
        order_coordinates = fetch_coordinates(settings.YANDEX_MAP_API, order_item.address)
        for restauran in order_item.restaurants:
            restauran_coordinates = fetch_coordinates(settings.YANDEX_MAP_API, restauran.address)
